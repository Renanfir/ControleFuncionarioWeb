...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarsExample02">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active"> <a class="nav-link" href="DepConsultaIndividualResposta.jsp">Consulta específica</a> </li>
    ...
    <div class="container mt-4">
        ...
        <form action="DepExclui_.jsp">
            <h1 style="margin-bottom: 40px">Exclui</h1>

...
<body>
    ...
    <div class="container mt-4">
        ...
        <form action="DepAltera_.jsp">
            <h1 style="margin-bottom: 40px">Altera</h1>
            <div class="form-group">
                
                <label for="descDepto">Descrição do departamento</label>
                <input style="margin-bottom: 10px" type="text" id="descDepto" name="descDepto" class="form-control" placeholder="Descrição:">
                
                <label for="idDepto">ID do departamento</label>
                <input type="text" id="idDepto" name="idDepto" class="form-control" placeholder="depto que deseja alterar">
            </div>
